# brana_colision.py - Colision entre branas
import os
import glfw
...
void main() {
    ...
    float electronFade = 1.0 - smoothstep(tHit - 0.4, tHit + 2.0, t);
    electronMask *= electronFade;
...
class BranaColision:
    def __init__(self, render_video=False):
        ...
        self.window = glfw.create_window(
            RESOLUTION[0], RESOLUTION[1], "Brana Colision", None, None
        )
...
if __name__ == "__main__":
    ...
    BranaColision(render_video=render_video).run()
