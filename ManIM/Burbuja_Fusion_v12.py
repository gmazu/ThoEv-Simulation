...
# v12: Ondas expansivas + chispazos/destellos en zona lila
from manim import *
import numpy as np
import random
...
class FusionBurbujas3D(ThreeDScene):
    def construct(self):
        ...
        radio_prueba = 0.5  # Radio donde aparece (medio camino)
        velocidad_encendido = 8.0  # Qué tan rápido se enciende
        velocidad_apagado = 1.5  # Qué tan lento se apaga
        # ═══════════════════════════════════════════════════════════════
        ...
        while t < 20:
            ...
            if fusionadas:
                ...
                # === GLOW DE PRUEBA (estela de primera onda) ===
                if ondas[0]['activa']:  # Solo con la primera onda
                    ...
                    if glow_estado['estado'] == 'inactivo' and radio_onda_1 >= radio_prueba:
                        ...
                        # Posición del glow (orientada según el círculo lila)
                        posicion_glow = centro + offset_glow
