...
# v16: Cada ola genera nuevo conjunto de galaxias (4 distribuciones diferentes)
from manim import *
import numpy as np
import random
            ...
            if fusionadas:
                ...
                for idx_onda, onda in enumerate(ondas):
                    if onda['activa']:
                        ...
                        # BORRAR conjunto anterior cuando esta onda se activa
                        if idx_onda > 0 and onda['tiempo'] < dt * 2:  # Recién activada
                            galaxias_anteriores = conjuntos_galaxias[idx_onda - 1]
                            for gal_ant in galaxias_anteriores:
                                if gal_ant['agregado']:
                        ...
                        for galaxia in galaxias_actuales:
                            ...
                            # === ACTUALIZAR POSICIÓN DE LA GALAXIA (SIN movimiento ondulatorio) ===
                            if galaxia['agregado']:
